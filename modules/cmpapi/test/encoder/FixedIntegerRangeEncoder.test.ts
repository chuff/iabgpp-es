import { FixedIntegerRangeEncoder } from "../../src/encoder/FixedIntegerRangeEncoder";
...
describe("encoder.FixedIntegerRangeEncoder", (): void => {
  ...
  it("should substring '1000000000010000000000000000111000000000000010100000000000010001' from index 1 to '00000000001000000000000000011100000000000001010000000000001000'", (): void => {
    expect(
      FixedIntegerRangeEncoder.substring("1000000000010000000000000000111000000000000010100000000000010001", 1)
